...
-   total suitable area by region
    ...
    tm_shape(zonal_rast)+
      ...
      tm_title(text = "Total Suitable Area by Region")+
...
tm_shape(zonal_rast)+
  ...
  tm_title(text = "Percent Suitable Area by Region")+
  tm_scalebar(position = c('left','bottom'))+
  tm_basemap(server = "OpenStreetMap")
```
...
```{r}
species_suitable_area = function(min_temp_C, max_temp_C, min_depth_m, max_depth_m){
