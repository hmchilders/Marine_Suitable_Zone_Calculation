...
-   select suitable cells within West Coast EEZs
    ...
    #User the mask to crop the coastal data to our area of interest (suitable areas)
...
```{r}
tm_shape(zonal_rast)+
  tm_polygons(fill = 'pct_suitable', alpha = 0.7)+
  tm_title(text = 'Suitable Area')+
